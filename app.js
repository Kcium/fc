...
class MaterialExchangeCalculator extends React.Component {
    ...
    this.setState(
      {
        ...
        resultMaterialsText: Object.entries(specialMaterials)
        ...
        normalMaterials,
        savingPercent: (
          (savingsAllCount / normalMaterialsAllCount) *
          100
        ).toFixed(1),
      },
      () => {
  ...
  drawSavingsChart = () => {
    ...
    const data = ["100", this.state.savingPercent];
                  ...
                  <div id="resultContainer">
                    <div className="bg-primary/5 rounded-xl p-4 mb-6">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div id="resultMaterialsText" className="font-medium">
                          {resultMaterialsText}
                        </div>
                      </div>
                    </div>
